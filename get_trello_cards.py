# This script gets the number of cards for a particular Trello board uses CURL requests
# to pull data using the Trello API.
# See the README.md to setup TRELLO_CREDENTIALS_PATH and credentials correctly.
#
